...
<body style="background-color: #f2f2f2;">
	...
	<section class=" mb-2 me-5 ms-5" style="background-color: rgb(233, 236, 239); height: 40px;">
		<div class="pt-2 ms-3">
			<a class="text-decoration-none text-dark" href="/home/index">
				<i class="bi bi-house-fill"></i>
			</a>
			/
			<a class="text-decoration-none text-dark" href="/home/shop">Điện thoại</a>
			/ ${pr.name}
		</div>
	</section>
	<section class="me-5 ms-5 mb-3">
		<div class="row">
			...
			<div class="col-md-5 mb-3">
				<div>
					<span class="fs-2">${pr.name}</span>
				</div>
				<div>
					<span class="fs-2 fw-bold" style="color: #be1e2d;">${pr.price}
						<span class="text-decoration-underline fs-4"> đ</span>
					</span>
				...
				<div class="card mt-2">
					<div class="card-header" style="background-color: #34a105;">
						...
						<div>
							<span>giá và khuyến mãi áp dụng đặt và nhận hàng 13/1 - 31/1</span>
						</div>
					</div>
					<div class="card-body">
						<div>
							<span>KHUYẾN MẠI TRẢ GÓP:</span>
						</div>
						<div>
							<span>Trả góp 0% qua Công ty tài chính(Áp dụng trên giá bán lẻ). </span>
						</div>
						<div>
							<span>Trả góp thời hạn 06-12 tháng qua thẻ tín dụng</span>
						</div>
						<div>
							<span>ƯU ĐÃI MUA KÈM</span>
						</div>
						<div>
							<span>Trợ giá 3 tháng cước khi nâng lên các gói trả sau V200S, V300S, V700S, V1000S.</span>
						</div>
						<div>
							<span>Thu cũ giá cao lên đến 20,000,000đ khi lên đời iPhone 14 Series.</span>
						</div>
					</div>
				</div>
				<div class="d-grid gap-2   mt-2">
					<a class="btn" href="/home/cart/add/${pr.id}" type="submit" style="background-color: orange;">
						<span class="fw-bold fs-4 text-white">Thêm giỏ hàng</span>
						<br>
						<span class="text-white">Thỏa mái lựa chọn, xem hàng tại nhà</span>
					</a>

				</div>
				<div class=" gap-2 mt-2">
					<div class="row">
						<button class="btn ms-5 col-5" type="button" style="background-color: #07bcb5;">
							<span class="fw-bold fs-4 text-white">MUA TRẢ GÓP 0%</span>
							<br>
							<span class="text-white">Thục tục đơn giản</span>
						</button>

						<button class="btn ms-1  col-5" type="button" style="background-color: #07bcb5;">
							<span class="fw-bold fs-4 text-white">TRẢ GÓP QUA THẺ</span>
							<br>
							<span class="text-white">Visa, Master, JCB, ATM</span>
						</button>
					</div>
				</div>
			</div>
			<div class="col-md-2">
				<div>
					<span class="fs-4">Thông số kỹ thuật</span>
				</div>
				<hr>
				<div>
					<span class="">Màn hình: </span>
					<span class=" text-align"> OLED, 2532 x 1170 pixel ở 460 ppi, 6.1", Kính cường lực Ceramic Shield</span>
				</div>
				<hr>
				<div>
					<span>CPU:</span>
					<span> Apple A15 Bionic, CPU 6 nhân với 2 nhân hiệu suất và 4 nhân hiệu quả, Apple GPU 5 nhân</span>
				</div>
				<hr>
				<div>
				...
				<div>
					<span>Hỗ trợ đa sim:</span>
					<span> 1 Nano SIM & 1 eSIM, Hỗ trợ 5G</span>
				</div>
				<hr>
				<div>
					<span>Wifi:</span>
					<span> Wi ‑ Fi 6 (802.11ax) với 2x2 MIMO Wi-Fi MIMO</span>
				</div>
				<hr>
				<div>
					<span>Danh bạ:</span>
