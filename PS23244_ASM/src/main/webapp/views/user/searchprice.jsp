		...
		<section class="mt-3">
					...
					<div class="col-md-3 ">
						...
						<div class="p-3">
							<a href="product/detail/${product.id}">
								<img src="../views/image/${product.image}" class="w-100 " alt="">
							</a>
						</div>
						<img src="../views/image/labelapple.png" class="ms-2 w-50 h-5" alt="">

						<div class="ms-2  me-5">
							<a href="product/detail/${product.id}" class="text-decoration-none"> ${product.name} </a>
						</div>
						...
						<a href="/home/cart/add/${product.id}" class="btn btn-outline-danger mt-1 mb-2"> Thêm giỏ hàng</a>
					</div>
				</c:forEach>
			...
			<div class="pb-1">
				<ul class="pagination d-flex justify-content-center">
					<li class="page-item">
						<a class="page-link" href="/home/price?p=0">1</a>
					</li>
					<c:forEach var="i" begin="1" end="${page.totalPages-1}">
						<li class="page-item">
							<a class="page-link" href="/home/price?p=${i}">${i+1}</a>
						</li>
					</c:forEach>
				</ul>
			</div>
