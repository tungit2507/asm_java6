...
<body>
 <header>
    ...
    <section class=" mb-2 me-5 ms-5" style="background-color: rgb(233, 236, 239); height: 40px;">
        <div class="pt-2 ms-3"><a class="text-decoration-none text-dark" href="index"><i class="bi bi-house-fill"></i></a> / <a class="text-decoration-none text-dark" href="shop">Điện thoại</a> / Thông tin giỏ hàng của bạn</div>
                ...
                <table class="table">
								...
								<form action="/home/cart/update" method="post">
									...
									<tr>
										<td class="cart-pic first-row"><img
											src="../views/image/${item.image}" alt="" style="width: 50px" ></td>
										...
										<td>
											<div class="">
												...
												<input name="qty" value="${item.qty}" min="0" onblur="this.form.submit()" class="text-center " style="width: 50px; height: 30px; font-size:18px; font-weight: bolder; border: none"> 
					...
					<div class="col-md-4">
						<div class="cart-buttons">
							<a href="/home/index" class="btn btn-info continue-shop" >Tiếp tục mua sắm
							</a> <a href="/home/cart/clear" class="btn btn-danger up-cart">Xóa giỏ hàng</a>
						</div>
						</div>
						...
						<div class="proceed-checkout">
								...
								<div class="fw-bold">Tổng tiền <span style="color: red">${cart.total} đ</span></div>
