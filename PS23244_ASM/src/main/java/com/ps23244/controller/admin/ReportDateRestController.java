...
@CrossOrigin("*")
@RestController
@RequestMapping("/rest/report-date")
...
//	
	...
	public Map<String, Object> getAll() {
	    ...
	    List<Order> orders = orderService.reportDate(firstDate, lastDate);

	    Map<String, Object> response = new HashMap();
	    response.put("orders", orders);
	    response.put("firstDate", firstDate);
	    response.put("lastDate", lastDate);
